...
class GuidlinesWidget extends StatefulWidget {
  const GuidlinesWidget({Key key}) : super(key: key);

  @override
  _GuidlinesWidgetState createState() => _GuidlinesWidgetState();
}

class _GuidlinesWidgetState extends State<GuidlinesWidget> {
          ...
          Padding(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    padding: EdgeInsetsDirectional.fromSTEB(0, 75, 20, 0),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
